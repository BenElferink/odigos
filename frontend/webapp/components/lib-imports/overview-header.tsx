...
import { FORM_ALERTS, MOCK_DESCRIBE_ODIGOS, MOCK_TOKENS, NOTIFICATION_TYPE, PLATFORM_TYPE } from '@odigos/ui-utils';
  ...
  return (
    <Header
      ...
      right={[
        ...
        <CliDrawer key='cli' tokens={MOCK_TOKENS} saveToken={async () => {}} describe={MOCK_DESCRIBE_ODIGOS} />,
